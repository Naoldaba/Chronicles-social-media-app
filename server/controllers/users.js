...
export const signin= async (req, res) => {
    try {
        ...
        const token = jwt.sign({email: registeredUser.email, id: registeredUser._id}, "test", {expiresIn: '1h'})
...
export const signup = async (req, res)=>{
    try {
        ...
        const token = jwt.sign({email: profileInfo.email, id: profileInfo._id}, "test", {expiresIn: '1h'})
